...
import { UserNotExistsError } from "../../../src/domain/errors/user/UserNotExistsError";
...
import { EncryptUserPasswordUseCase } from "../../../src/domain/useCases/user/encryptUserPassword.usecase";
